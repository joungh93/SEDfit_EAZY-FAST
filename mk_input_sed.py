...
dir_phot = "/data/jlee/DATA/JWST/First/SMACS0723/Align/Phot/"
...
for i in range(len(bands_jwst)):
    mag_cnd = (mag_cnd & (phot_data[bands_jwst[i]]['mag_auto'] < 30.0))
    merr_cnd = (merr_cnd & (phot_data[bands_jwst[i]]['e_mag_auto'] < 1.0))
